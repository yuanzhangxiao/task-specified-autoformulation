...
Then submit one six-proposal, no-judge, development-only pilot:
...
export AF_OUTPUT_ROOT="$AF_WORK/phase_b/local-generation-pilot-v4"
...
judge events, and six or fewer proposer provider calls. Do not launch all 40
