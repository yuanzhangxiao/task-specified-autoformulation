#!/usr/bin/env python3
"""Freeze or run the matched staged-function granularity experiment."""
...
def main() -> None:
    """Keep plan freezing independent from the local model server."""
    ...
    if args.command == "freeze":
        result = freeze_granularity_campaign(
            args.config,
