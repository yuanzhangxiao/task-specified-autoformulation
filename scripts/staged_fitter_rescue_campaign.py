#!/usr/bin/env python3
"""Freeze, run, or summarize the staged six-candidate fitter rescue."""
...
from autoformalism.rebuttal.staged_fitter_rescue_campaign import (
    freeze_campaign,
    run_task,
    summarize_campaign,
)
...
def main() -> None:
    ...
    freeze.add_argument("--source-fitting-root", type=Path, required=True)
    ...
    if args.command == "freeze":
        result = freeze_campaign(
            args.config, args.source_fitting_root, args.output_root
        )
