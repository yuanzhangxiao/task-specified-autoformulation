#!/bin/bash
# Fresh v7: matched v6 inputs and fitter, audited assembly ownership rules.
set -euo pipefail
...
export AF_SOURCE_ROOT="${AF_SOURCE_ROOT:-$group/detention-process-pilot-v6}"
export AF_AUDIT_ROOT="${AF_AUDIT_ROOT:-$group/process-revision-audit-v1}"
export AF_OUTPUT_ROOT="${AF_OUTPUT_ROOT:-$group/detention-process-pilot-v7}"
...
"$AF_PYTHON" scripts/process_revision_confirmation.py prepare \
