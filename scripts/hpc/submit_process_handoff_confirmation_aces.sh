#!/bin/bash
# Fresh v4 pilot: import public v3 inputs, never its calls or selected models.
set -euo pipefail
...
export AF_SOURCE_ROOT="${AF_SOURCE_ROOT:-$group/detention-process-pilot-v3}"
export AF_AUDIT_ROOT="${AF_AUDIT_ROOT:-$group/process-handoff-audit-v1}"
export AF_OUTPUT_ROOT="${AF_OUTPUT_ROOT:-$group/detention-process-pilot-v4}"
...
"$AF_PYTHON" scripts/process_handoff_confirmation.py prepare \
