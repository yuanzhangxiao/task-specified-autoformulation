#!/bin/bash
# Fresh v6: matched v5 inputs and fitter, audited assembly ownership rules.
set -euo pipefail
...
export AF_SOURCE_ROOT="${AF_SOURCE_ROOT:-$group/detention-process-pilot-v5}"
export AF_AUDIT_ROOT="${AF_AUDIT_ROOT:-$group/process-assembly-audit-v2}"
export AF_OUTPUT_ROOT="${AF_OUTPUT_ROOT:-$group/detention-process-pilot-v6}"
...
"$AF_PYTHON" scripts/process_assembly_confirmation.py prepare \
