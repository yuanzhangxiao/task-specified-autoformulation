...
readonly submission_dir="${AF_D3_OUTPUT_ROOT}/submissions/${submission_id}"
[[ -e "${submission_dir}" ]] && {
...
readonly common="ALL,AF_REPO_ROOT=${AF_REPO_ROOT},AF_PYTHON=${AF_PYTHON},AF_D3_OUTPUT_ROOT=${AF_D3_OUTPUT_ROOT},AF_LOCAL_MODEL=${AF_D3_MODEL},AF_SUBMISSION_DIR=${submission_dir},AF_BATCH_SIZE=${AF_BATCH_SIZE},AF_D3_CONFIG=${AF_D3_CONFIG},AF_PUBLIC_ROOT=${AF_PUBLIC_ROOT},AF_TENSOR_PARALLEL_SIZE=${AF_TENSOR_PARALLEL_SIZE}"

export AF_SUBMISSION_ID="${submission_id}"
export AF_SUBMISSION_BATCHES="${batches}"
export AF_SUBMISSION_MODEL="${AF_D3_MODEL}"
export AF_SUBMISSION_CONFIG="${AF_D3_CONFIG}"
export AF_SUBMISSION_OUTPUT_ROOT="${AF_D3_OUTPUT_ROOT}"
