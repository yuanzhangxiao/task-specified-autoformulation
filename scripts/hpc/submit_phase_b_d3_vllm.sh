...
readonly common="ALL,AF_MODULES=${AF_MODULES:-},AF_REPO_ROOT=${AF_REPO_ROOT},AF_PYTHON=${AF_PYTHON},AF_D3_OUTPUT_ROOT=${AF_D3_OUTPUT_ROOT},AF_LOCAL_MODEL=${AF_D3_MODEL},AF_SUBMISSION_DIR=${submission_dir},AF_BATCH_SIZE=${AF_BATCH_SIZE},AF_D3_CONFIG=${AF_D3_CONFIG},AF_PUBLIC_ROOT=${AF_PUBLIC_ROOT},AF_TENSOR_PARALLEL_SIZE=${AF_TENSOR_PARALLEL_SIZE}"
