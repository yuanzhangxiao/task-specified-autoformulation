...
if [[ "${worker_script}" == prefit_construction_campaign.py || "${worker_script}" == prefit_feedback_campaign.py || "${worker_script}" == prefit_requirement_campaign.py || "${worker_script}" == prefit_numerical_sibling.py ]]; then
