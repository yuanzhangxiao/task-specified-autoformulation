#!/bin/bash
# Fresh v5: matched v4 public inputs, audited local dependency corrections.
set -euo pipefail
...
export AF_SOURCE_ROOT="${AF_SOURCE_ROOT:-$group/detention-process-pilot-v4}"
export AF_AUDIT_ROOT="${AF_AUDIT_ROOT:-$group/function-dependency-audit-v1}"
export AF_OUTPUT_ROOT="${AF_OUTPUT_ROOT:-$group/detention-process-pilot-v5}"
...
"$AF_PYTHON" scripts/function_dependency_confirmation.py prepare \
