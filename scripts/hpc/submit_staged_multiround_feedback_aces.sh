...
readonly output_root="${AF_OUTPUT_ROOT:-${scratch_root}/phase_b/staged-multiround-feedback-v5-aces-h100x1}"
readonly account="${AF_ACCOUNT:-156264627414}"
readonly config="${AF_CONFIG:-${repository}/configs/staged_multiround_feedback_v5.json}"
