#!/usr/bin/env python3
"""Freeze or run the six-topology hybrid function pre-fit handoff."""
...
def main() -> None:
    """Keep freezing independent from the local model server."""
    ...
    if args.command == "freeze":
        result = freeze_function_prefit_campaign(
            args.config,
            args.source_root,
            args.output,
        )
